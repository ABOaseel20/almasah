...
<div class="d-flex">
    ...
    <div id="sidebar" class="sidebar p-3">
        ...
        <ul class="nav flex-column">
            ...
            <li>
                <a class="nav-link <?php echo e(request()->routeIs('halls.*')?'active':''); ?>"
                   href="<?php echo e(route('halls.index')); ?>">
                   <i class="bi bi-building"></i> القاعات
                </a>
            </li>

            <li>
                <a class="nav-link <?php echo e(request()->routeIs('bookings.*')?'active':''); ?>"
...
</html><?php /**PATH C:\Users\mycar\almasah-palace\resources\views/layouts/master.blade.php ENDPATH**/ ?>